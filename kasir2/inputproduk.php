    ...
    if(isset($_GET['pesan'])){
    	...
    	<div class="alert alert-danger" role="alert">
		  <b>Gagal Di Simpan</b>
		    ...
		    ?>
	<form method="post" action="./proses/prosesinputprodukpc.php">

  <div class="form-group">
    <label for="" style="color: white;">Nama Produk PC</label>
    <input type="text" class="form-control" id="exampleInputEmail1" name="namaprodukpc" aria-describedby="emailHelp" placeholder="Nama Produk PC">
  </div>
  <div class="form-group">
    <label for="" style="color: white;">Jenis Produk PC</label>
    <textarea class="form-control" placeholder="Jenis Produk PC" name="jenisprodukpc"></textarea>
  </div>
  <button type="submit" class="btn btn-danger">Tambah</button>
  <a href="produkpc.php"><input class="btn btn-link" type="button" value="Kembali"></input></a>
</form>         
