    ...
    if(isset($_GET['pesan'])){
    	...
    	<div class="alert alert-danger" role="alert">
		  <b>Gagal Di Simpan</b>
		    ...
		    ?>
	<form method="post" action="./proses/prosesinputpelanggan.php">

  <div class="form-group">
    <label for="" style="color: white;">ID Pelanggan</label>
    <input type="text" class="form-control" id="exampleInputEmail1" name="idpelanggan" aria-describedby="emailHelp" placeholder="ID Pelanggan">
  </div>
  <div class="form-group">
    <label for="" style="color: white;">Nama Pelanggan</label>
    <textarea class="form-control" placeholder="Nama Pelanggan" name="namapelanggan"></textarea>
  </div>
  <button type="submit" class="btn btn-danger">Tambah</button>
  <a href="DataPelanggan.php"><input class="btn btn-link" type="button" value="Kembali"></input></a>
</form>         
